...
* @link       http://ark.lparchaeology.com/svn/config/mod_abk_settings.php
...
// A subform which handles modtype conflict issues raised by $conf_mcd_abktype, used in when editing modtype
...
// A text subform for the address book basics
$conf_mcd_abkdesc =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'desc', 
        'sf_html_id' => 'abk_desc', // Must be unique
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_abk_userconf', // Must be unique
