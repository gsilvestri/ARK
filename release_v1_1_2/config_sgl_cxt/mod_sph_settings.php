...
/**
* config/mod_sph_settings.php
*
* Settings file for the module sph (site photos)
...
* @link       http://ark.lparchaeology.com/svn/config/ark_cxt/mod_sph_settings.php
...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'sph_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'sph_itemval', // Must be unique
...
$conf_mcd_sphdesc =
    array(
        ...
        'sf_html_id' => 'sph_img_desc', //the form id tag (must be unique)
...
$conf_mcd_cxtxmi =
    array(
        ...
        'sf_html_id' => 'sph_cxt_display', //the form id tag (must be unique)
...
$conf_mcd_takenevent =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'sphmeta', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'sph_events', //the form id tag (must be unique)
...
// No detailed view in this settings file
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_sphuserconf', // Must be unique
