...
* @link       http://ark.lparchaeology.com/svn/config/ark_cxt/page_settings.php
...
$uhlp_subform_module =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'none',
        'sf_title' => 'uhlpmodlist', 
        'sf_html_id' => 'uhlpmodlist', // Must be unique
...
$fu =
    array(
     'on' => TRUE,
     'pattern' => array(
        'pat1'=>"/\b[a-zA-Z]*\-(([0-9]*)|(([0-9]*)-[a-z0-9A-Z]*))\.[a-z0-9]{2,4}\b/i", 
        'pat2' => "/\b[a-zA-Z]* (([0-9]*)|(([0-9]*)-[a-zA-Z0-9]*))\.[a-zA-Z]{2,4}\b/i",
    ),
);
...
$link_list_stdcriteria[] = 
     array(
         'href' => "{$_SERVER['PHP_SELF']}?ftr_id=new&amp;ftype=atr&amp;atr=209&amp;atrtype=1&amp;bv=1", 
         'mknname' => 'reccomplete',
         'img' => 'view_mag.png',
         'lightbox' => FALSE,
         'css_class' => FALSE
...
$link_list_stdcriteria[] = 
     array(
         'href' => "{$_SERVER['PHP_SELF']}?ftr_id=new&amp;ftype=atr&amp;atr=209&amp;atrtype=1&amp;bv=zero", 
         'mknname' => 'reccompleteno',
         'img' => 'view_mag.png',
         'lightbox' => FALSE,
         'css_class' => FALSE
);
