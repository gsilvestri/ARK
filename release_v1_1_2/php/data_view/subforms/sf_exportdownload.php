...
/**
* data_view/subforms/sf_exportdownload.php
*
* a data_view subform for creating downloads from result sets
*
...
if ($update_db === $sf_conf['sf_html_id']) {
    ...
    include_once ('php/data_view/subforms/update_exportdownload.php');
...
switch ($sf_state) {
    ...
    case 'overlay':
        ...
        if ($process) {
            ...
            if ($dl_success) {
                ...
                echo "<div class=\"download\"><a href=\"download.php?fullpath=1&amp;file=$dl\">$mk_dl</a></div>\n";
            } else {
                // printPre($error);
    ...
    case 'no_results':
        echo "<div id=\"sf_exportdownload\" class=\"{$sf_cssclass}\">\n";
        // put in the nav
   ...
   default:
       ...
       echo "<p>ADMIN ERROR: the sf_state for sf_exportdownload was incorrectly set</p>\n";
