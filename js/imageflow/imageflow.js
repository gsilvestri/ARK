...
var conf_download = 'download_file';          // Default is 'slider'
    ...
    for (var index = 0; index < max; index++)
    {
        ...
        else 
        {
            ...
            switch ( image.i == caption_id )
            {
                ...
                default:
                    zIndex = zIndex + 1;
                    file_id =  image.url.split("/");
                    file_id = file_id[file_id.length-1];
                    download_div_link.href = "php/download.php?file=" +  file_id;
                    download_div_link.innerHTML =  download_markup + image.getAttribute('alt');
...
function refresh(onload)
{
    ...
    img_link = document.getElementById(conf_images);
    ...
    //to provide the download link
    
    download_div = document.getElementById(conf_download);
    download_div_link = download_div.childNodes.item(0);
    download_markup = download_div_link.innerHTML;
    ...
    { 
        ...
        if (image.nodeType == 1)
        {
            ...
            image.url = image.getAttribute('long_desc');
