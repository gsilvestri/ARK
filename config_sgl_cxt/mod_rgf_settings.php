...
/**
* config/mod_rgf_settings.php
*
* Settings file for the module rgf (registered finds)
...
* @link       http://ark.lparchaeology.com/svn/config/ark_cxt/mod_rgf_settings.php
...
$conf_mcd_itemval_conflicts =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'dnarecord', 
        'sf_html_id' => 'rgf_itemvalconflict', // Must be unique
...
$conf_mcd_itemval =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'itemval', 
        'sf_html_id' => 'rgf_itemval', // Must be unique
...
$conf_mcd_modtype_conflicts =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'rgftypeconflicts', 
        'sf_html_id' => 'rgf_modtypeconflict', // Must be unique
...
$conf_mcd_modtype =
    array(
        ...
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'rgftype', 
        'sf_html_id' => 'rgf_modtype', // Must be unique
...
$conf_mcd_rgfdesc =
    array(
        ...
        'sf_html_id' => 'rgf_img_desc', //the form id tag (must be unique)
...
// Registered finds comments
$conf_mcd_rgfcomment =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_title' => 'rgfcomment', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'rgf_comment', //the form id tag (must be unique)
        'script' => 'php/subforms/sf_txt.php',
        'sf_nav_type' => 'nmedit',
        'op_label' => 'space',
        'op_input' => 'edit',
...
$conf_mcd_rgfbasicinterp =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'rgfbasicinterp', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'rgf_basicinterp', //the form id tag (must be unique)
...
// Registered finds display characteristics
$conf_mcd_rgfdispchars =
    array(
        'view_state' => 'max',
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
...
$conf_mcd_xmirgfcxt =
    array(
        ...
        'edit_state' => 'view',
        'sf_nav_type' => 'nmedit',
        'sf_title' => 'rgfxmicxt', //appears in the titlebar of the subform (mk nname)
        'sf_html_id' => 'rgf_xmi_cxts', //the form id tag (must be unique)
...
$conf_mcd_event =
    array(
        ...
        'sf_html_id' => 'rgf_events', //the form id tag (must be unique)
...
$conf_register =
    array(
        ...
        'sf_html_id' => 'rgf_cd_register', //the form id tag (must be unique)
        'sf_nav_type' => 'none',
...
$conf_mac_userconfigfields =
    array(
        ...
        'sf_html_id' => 'mac_rgfuserconf', // Must be unique
